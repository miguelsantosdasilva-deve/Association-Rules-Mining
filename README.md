...
supermarket.arff                      # Weka sample dataset (4,627 transactions) — included
...
1. Install dependencies:
   ...
   ```
2. Run the notebook to clean the data and generate `supermarket_clean.csv`:
   ```bash
   jupyter notebook association_rules_apriori.ipynb
   ```
3. Load `supermarket_clean.csv` into the Weka Explorer (Associate tab > Apriori) and configure the parameters described above.
